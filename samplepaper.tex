...
%
\author{Lina Teresa Molinas Comet\inst{1}}
%
...
%
\begin{abstract}
Stories always have been present in human’s life, whether in forms of speeches or images helping to transmit messages and knowledge between generations. Furthermore, there have been changes in the way of telling stories, and as a consequence nowadays the tendency is to present information with a combination of data (in form of graphs and visual representations) with other media tools such as video, voice, audio, and text with the aim of making the information more recognizable and the story more coherent, allowing interaction with the audience and getting their attention and awareness. As a result of this trend, we present an overview of the most interesting techniques and tools for visual storytelling, as well as the influence of the Semantic Web, and the Web in general for telling stories with a variety of purposes, such as promoting collaboration and the spread of knowledge.

The abstract should briefly summarize the contents of the paper in
15--250 words.

\keywords{Knowledge Graphs  \and Clustering \and Knowledge Base}
\end{abstract}
%
%
%
