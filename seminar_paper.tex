...
\captionof{table}{Comparison of presented approaches} \label{table1}
\begin{tabular}{|p{3cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|}
 \hline
\textbf{Algorithm} & \textbf{Input} & \textbf{Measurement} & \textbf{Application} & \textbf{Issues}\\
 \hline
 Knowledge Clustering in P2PPKM & Domain specific ontologies & Semantic distance (shortest path) and bi-section k-modes & Content/expertise extraction & bla bla \\
 \hline
  Knowledge Clustering in P2PPKM & Domain specific ontologies & Semantic distance (shortest path) and bi-section k-modes & Content/expertise extraction & bla bla \\
 \hline
\end{tabular}
